...
//         row.insertCell().textContent = u.text;
//         row.insertCell().textContent = u.isPublic;
//
//         // Display image URLs
//         const imageCell = row.insertCell();
//         if (u.imageUrls && u.imageUrls.length > 0) {
//             const imageContainer = document.createElement('div');
//             u.imageUrls.forEach(imageUrl => {
...
//         } else {
//             imageCell.textContent = 'No images';
//         }
//
//         // Display video URLs
//         const videoCell = row.insertCell();
//         if (u.videoUrls && u.videoUrls.length > 0) {
//             const videoContainer = document.createElement('div');
//             u.videoUrls.forEach(videoUrl => {
...
//         } else {
//             videoCell.textContent = 'No videos';
//         }
//
//         row.insertCell().textContent = u.createdDate;
//         row.insertCell().textContent = u.updatedDate;
//         row.insertCell().textContent = u.status;
//     });
// };
...
const fetchData = async () => {
    ...
    const contentResponse = await fetch(`/groupContents/${groupId}`);
    const shareResponse = await fetch(`/groupShares/${groupId}`);
    const pollResponse = await fetch(`/groupPolls/${groupId}`);
...
// Share icon click event listener
    ...
    //         newFeedOption.textContent = "Profile";
...
// to show data in post update12 modal post //
...
const populatedTable1 = async (share) => {
    ...
    // }
    // const contentData = await response1.json();
        ...
        postBody.style.marginLeft = '-21px';
